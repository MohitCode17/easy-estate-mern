...
const Profile = () => {
  ...
  // File Upload to Firebase function
  ...
  return (
    <div className="max-w-lg mx-auto p-3">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <button
          disabled={loading}
          className="bg-slate-700 text-white p-3 font-bold uppercase rounded-lg hover:opacity-95"
        >
          {loading ? "Loading..." : "Update"}
        </button>
        <Link
          to={"/create-listing"}
          className="bg-green-700 text-white p-3 font-bold uppercase rounded-lg text-center hover:opacity-95"
        >
          Create Listing
        </Link>
      </form>
      ...
      {userListings && userListings.length > 0 && (
        <div>
          <h1 className="text-center mt-7 mb-3 text-2xl font-semibold">
            Your Listings
          </h1>
            ...
            >
              ...
              <div className="flex flex-col items-center">
                ...
                <Link to={`/update-listing/${listing._id}`}>
                  <button className="green-red-700 uppercase text-sm">
                    Edit
                  </button>
                </Link>
              </div>
